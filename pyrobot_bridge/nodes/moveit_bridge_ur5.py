...
class MoveitInterface(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("pyrobot_moveit_ur5")

        self.moveit_server_ = actionlib.SimpleActionServer(
            "/pyrobot/ur5/moveit_server",
            MoveitAction,
        ...
        self._traj_action = actionlib.SimpleActionClient("execute_trajectory", ExecuteTrajectoryAction)
    ...
    def _init_moveit(self):
        ...
        """
        self.moveit_planner = rospy.get_param("pyrobot/ur5/moveit_planner")
        moveit_commander.roscpp_initialize(sys.argv)
        mg_name = rospy.get_param("pyrobot/ur5/move_group_name")
