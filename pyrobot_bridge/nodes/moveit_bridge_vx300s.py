...
class MoveitInterface(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("pyrobot_moveit_vx300s")

        self.moveit_server_ = actionlib.SimpleActionServer(
            "/pyrobot/vx300s/moveit_server",
            MoveitAction,
        ...
        self._traj_action = actionlib.SimpleActionClient("/vx300s/execute_trajectory", ExecuteTrajectoryAction)
    ...
    def _init_moveit(self):
        ...
        """
        self.moveit_planner = rospy.get_param("pyrobot/vx300s/moveit_planner")
        moveit_commander.roscpp_initialize(sys.argv)

        mg_name = rospy.get_param("pyrobot/vx300s/move_group_name")
        rd_name = rospy.get_param("pyrobot/vx300s/robot_description")

        self.robot = moveit_commander.RobotCommander(rd_name, "vx300s")
        self.scene = moveit_commander.PlanningSceneInterface("vx300s")
        self.moveit_group = moveit_commander.MoveGroupCommander(mg_name, rd_name, "vx300s")
