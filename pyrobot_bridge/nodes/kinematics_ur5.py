...
class Kinematics(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("pyrobot_kinematics_ur5")

        self.ik_srv = rospy.Service("pyrobot/ur5/ik", IkCommand, self.ik_server)
        self.fk_srv = rospy.Service("pyrobot/ur5/fk", FkCommand, self.fk_server)
        rospy.spin()

    def _init_kinematics(self):
        # Ros-Params
        base_link = rospy.get_param("pyrobot/ur5/base_link")
        gripper_link = rospy.get_param("pyrobot/ur5/gripper_link")
        robot_description = rospy.get_param("pyrobot/ur5/robot_description")
